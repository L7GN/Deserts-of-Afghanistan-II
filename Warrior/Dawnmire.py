...
file = open("CharacterStealth.txt","r")
lines = file.readlines()

for line in lines:
    for c in line:
        if c.isdigit() == True:
            player.stealth = int(c)
            if player.stealth == 6:
                print ("Nana")
            else:
                print ("NIGA")
            file.close
file = open("CharacterStrength.txt","r")
lines = file.readlines()

for line in lines:
    for c in line:
        if c.isdigit() == True:
            player.strength = int(c)
            print (c)
            if player.strength == 1:
                ...
                print ("NIGE")
            file.close
file = open("CharacterHealth.txt","r")
lines = file.readlines()
...
for line in lines:
    for c in line:
        if c.isdigit() == True:
            ...
            file.close
file.close()
file = open("CharacterSpeed.txt","r")
lines = file.readlines()
...
def TheKing():
    ...
    time.sleep(3)
    print ("Shadow Man: Now i can reach my maximum power")
    ...
    time.sleep(3)
    print ("Blood from the battle begins to be picked up by a force")
    time.sleep(4)
...
def THEEND():
    ...
    time.sleep(4)
    print ("They surround Kavu and attack him from all angles")
    time.sleep(3)
